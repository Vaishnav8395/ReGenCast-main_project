...
st.set_page_config(page_title = "ReGenCast – Renewable Energy Forecasting", page_icon = ':sun_small_cloud:', layout="wide")
...
if selected_subpage == "Home":
        ...
        #image
        with col1:
                st.image('https://github.com/Vaishnav8395/ReGenCast-main_project/blob/main/Solar-Energy-main/Site-18.jpg?raw=true', caption = '')
